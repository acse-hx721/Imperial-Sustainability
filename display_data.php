...
<!-- 			<div class="subfooter">
		...
		function drawSKMap_year(all_sites_obj_year, last_year, last_last_year, unit){
		...
		Papa.parse(filename, {
		  ...
		  complete: function(results) {
			...
			if (meter_location == "campus"){
				...
				drawSKMap_year(all_sites_obj_year, last_year, last_last_year, unit);
			}else if (meter_location != "campus" && meter_location != "null"){
				console.log(this_site_channel_obj);
